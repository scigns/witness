 ...
 * that a marketing reviewer adds here (or, once wired, that this page fetches
 * from the public read-only stories endpoint the customer-learning track's
 * feedback-review workflow produces) - never text pasted into a page's own
 * source. See docs/commercial-website/DECISIONS.md's customer-evidence
 * approval gate: a story appears here only after an organisation and its
 * participants have given explicit publication consent, reviewed by
 * marketing, independent of the underlying product feedback that led to it.
 */
interface PublishedStoryCard {
...
const publishedStories: readonly PublishedStoryCard[] = [];
        ...
        <Section id="stories" className="homepage-section">
          <div className="feature-grid audience-grid">
            {publishedStories.map((story) => (
              <FeatureCard key={story.organisationLabel} title={story.organisationLabel}>
