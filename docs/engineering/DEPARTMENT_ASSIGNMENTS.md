...
| D6         | Security Lead        | 1.7 Threat model (STRIDE) & PIA         | `UNASSIGNED` | none               | 🟡 started   | `docs/threat-model`             | Signed off; mitigations in the risk register; Security Lead                       |
...
| D2         | Principal Architect  | 1.1 C4 component views                  | agent (D2)   | ADR-0021 ✅        | 🟡 drafted, PR open — pending review | `docs/architecture/c4-component-views` | Mermaid in-repo, reviewed; Principal Architect + CTO                              |
