...
| ---------- | -------------------- | --------------------------------------- | ------------ | ------------------ | ------------ | ------------------------------- | --------------------------------------------------------------------------------- |
| D8         | UX Lead              | 1.9 Accessibility & i18n strategy       | agent (D8)   | none                | 🟡 drafted, PR open — pending review | `docs/ux/accessibility-i18n-strategy` | WCAG 2.2 AA plan, RTL approach, low-bandwidth budget; UX Lead + D10               |
| D2         | CTO                  | 1.10 NFRs & SLOs                        | agent (D2)   | none                | 🟡 merged to main — pending Principal Architect + CTO sign-off | _(merged)_ | Latency, throughput, availability, recovery quantified; CTO + Principal Architect |
| D6         | Security Lead        | 1.7 Threat model (STRIDE) & PIA         | agent (D6)   | none                | 🟡 drafted, PR open — pending review | `docs/security/threat-model-pia` | Signed off; mitigations in the risk register; Security Lead                       |
...
| D2         | Principal Architect  | 1.1 C4 component views                  | agent (D2)   | ADR-0021 ✅        | 🟡 merged to main — pending Principal Architect + CTO sign-off | _(merged)_ | Mermaid in-repo, reviewed; Principal Architect + CTO                              |
| D2         | Principal Architect  | 1.2 Domain model & bounded contexts     | `UNASSIGNED` | 1.1                | ⚪ available | `docs/bounded-contexts`         | Aggregates, invariants, context map; Principal Architect                          |
