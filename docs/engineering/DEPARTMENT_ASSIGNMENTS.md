...
| ---------- | -------------------- | --------------------------------------- | ------------ | ------------------ | ------------ | ------------------------------- | --------------------------------------------------------------------------------- |
| D8         | UX Lead              | 1.9 Accessibility & i18n strategy       | `UNASSIGNED` | none               | ⚪ available | `docs/accessibility-strategy`   | WCAG 2.2 AA plan, RTL approach, low-bandwidth budget; UX Lead + D10               |
| D2         | CTO                  | 1.10 NFRs & SLOs                        | agent (D2)   | none                | 🟡 drafted, PR open — pending review | `docs/nfrs-and-slos`            | Latency, throughput, availability, recovery quantified; CTO + Principal Architect |
