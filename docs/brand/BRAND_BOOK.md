...
Screenshot folders, spreadsheet trackers, and the sentence "trust me, it happened."
...
Nothing gets lost, nothing gets embellished. If Witness says it happened, it happened.

### One line, in the wild

> Witness keeps the receipts, so your team can keep moving.
...
Onboarding: warmest. Records and audit views: flattest. Incidents: shortest.

### Never

Exclamation marks, emoji, "Oops!", courtroom metaphors, watchdog language.

### Voice in use

| Context | Say this | Not that |
| --- | --- | --- |
| Sign-in | Welcome back. Your record is where you left it. | Secure Access Portal - Authenticate to Continue |
| Empty state | No records yet. The first one starts the moment you begin work. | Nothing here! Let's get you started on your journey. |
| Gap found | Two steps have no evidence attached. Add it now, or mark why it's missing. | Warning: Compliance violation detected in your workflow! |
| Success | Recorded. Sent to Dana for sign-off. | Success! Your data has been securely and permanently immutably stored. |
| Buttons | Start recording / Attach evidence / Send for sign-off | Get Started / Submit / Learn More |
...
| Token | Hex | Use |
| --- | --- | --- |
| Ink | `#1B1917` | Primary dark |
| Graphite | `#46423D` | Secondary dark |
| Ash | `#8A857D` | Neutral |
| Mist | `#DCD6CC` | Hairlines/dividers |
| Bone | `#F5F2ED` | Dominant ground |
| Gesso | `#FFFDF9` | Panels |
| Ember | `#C1481D` | Accent: live, unresolved, needing attention |
| Blush | `#E3B4A2` | Warm-but-passive support |
...
## 06 - Typography: Three voices, clearly divided

### Display - Newsreader

Newsreader Light 300 and Regular 400; italic for pull-quotes.

- Hero: 64/62, tracking -3.5%
- Section head: 44/46, tracking -2.5%
- Pull-quote italic: 26/34, tracking -1%

### Interface & body - IBM Plex Sans

IBM Plex Sans 300-600. Body 16/1.6. Never below 13px in product.

- Subhead/card title: 22/28, weight 500
- Body: 16/26, weight 400, measure capped around 68 characters
- Secondary/helper: 14/21, weight 400

Plex Sans carries tables, forms, navigation and body copy.
...
1. **Scrimmed hero:** bottom-weighted Ink gradient; default.
2. **Ghosted field:** 15-25% opacity behind text-led sections.
3. **Band:** thin slice of paint as a rule between sections.

### Also allowed

- Documentary photography of real work, desaturated a half-step.
- Screenshots of the actual product, cropped tight, never in a tilted device.
- Hairline diagrams in Ink and Mist, one weight, no fills.

### Never

- Stock photos of handshakes, gavels, magnifying glasses or eyes.
- Padlocks, shields, checkmark badges or blockchain cubes.
- Generated abstract renders, glowing nodes or particle networks.
- Paintings as pattern, tile, texture overlay or logo fill.

## 08 - Application: Sign-in and the record
...
Hairline rules, no card shadows, 4px radius maximum. Gesso panels on Bone ground.
...
Records are lists first. Show time, actor and state on every row before anything else.

## 09 - Guardrails: Do & don't

### Do

- Let white space carry the seriousness.
- Write the specific number, name and time.
- Keep Mono for machine facts only.
- Reserve Ember for what is live or unresolved.
- Use paint full-bleed, at cover scale.
- Name gaps out loud.
- Show the real product, cropped tight.

### Don't

- Say bulletproof, guaranteed or 100%.
- Use security clip-art: locks, shields, gavels.
- Put type over active brushwork.
- Add a second accent color "just for this".
- Use surveillance framing: watch, catch, police.
- Center body copy or justify text.
- Ship an interface louder than the evidence in it.

> If a choice makes the record easier to trust a year from now, it is on brand.
