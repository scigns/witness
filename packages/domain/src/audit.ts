...
export const AUDIT_ACTIONS = [
  ...
  // Workspace invitation — external-collaborator onboarding (ADR-0028).
  'workspace_invitation.created',
  'workspace_invitation.resent',
  ...
  'co_design_session.updated',
  'co_design_session.facilitator_changed',
  ...
  'session_participant.joined_via_link',
  // Governed QR/link session joining (Phase 5, Workstream 1.6).
  'session_join_link.created',
  'session_join_link.revoked',
  'session_join_link.expired',
  ...
  'session_summary.processing_started',
  'session_summary.completed',
  'session_summary.failed',
  'session_summary.retried',
  'session_summary.edited',
  ...
  'knowledge_candidate.clarification_requested',
  'knowledge_candidate.clarification_responded',
  'knowledge_candidate.returned_for_community_validation',
